...
\ce{$\unicode[
	...
	background-repeat:no-repeat;
	 animation: bounce 3.5s linear infinite,
               fade-out 2s linear infinite alternate,
    ...
    40% {
      transform: translateY(-30px); /* Ajusta este valor para la altura del rebote */
    }
    60% {
      transform: translateY(-15px); /* Ajusta este valor para la altura del rebote */
    }
  }
